    ...
    public function toArray($request)
    {
        ...
        if ($this->account_type === 'author') {
            return [
                ...
                'ai_review_status' => $this->ai_review_status ?? null,
                'ai_review_notes' => $this->ai_review_notes ?? null,
                'ai_review_confidence' => $this->ai_review_confidence ?? null,
                'ai_reviewed_at' => $this->ai_reviewed_at?->toISOString() ?? null,
                'kyc_info' => $this->relationLoaded('kycInfo') && $this->kycInfo ? [
                    ...
                    'document_type' => $this->kycInfo->document_type ?? null,
                    'document_url' => $this->kycInfo->document_url ?? null,
                    'document_uploaded_at' => $this->kycInfo->document_uploaded_at?->toISOString() ?? null,
                ...
                'voice_status' => $this->voice_status ?? null,
