...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::middleware(['role:admin,superadmin'])->patch('books/{book}/ios-availability', [BookController::class, 'toggleIosAvailability'])->name('book.toggle-ios-availability');
    ...
    Route::middleware(['role:admin,superadmin'])->get('admin/users/{userId}/library', [BookController::class, 'adminGetUserLibrary'])->name('admin.user.library')->where('userId', '[0-9]+');
...
Route::middleware(['auth:sanctum', 'role:manager,superadmin'])->prefix('admin')->group(function () {
    ...
    Route::prefix('kyc')->group(function () {
        ...
        Route::post('{user}/notify',  [AdminKYCController::class, 'notify'])->name('admin.kyc.notify');
    });
