...
@section('content')
  <p style="margin:0 0 8px;font-size:13px;font-weight:600;color:#D8B99C;text-transform:uppercase;letter-spacing:1px;">Reader Registration</p>
  ...
  <p style="margin:0 0 24px;font-size:15px;color:#4a3728;line-height:1.7;">
    Welcome to SBA Reads! To complete your account setup, please use the verification code below.
  </p>
  ...
  <p style="margin:0 0 24px;font-size:14px;color:#6b5448;line-height:1.7;">
    Enter this 4-digit code in the app to verify your email and start exploring books on SBA Reads.
  </p>
    ...
    <tr>
      <td style="background:#f5f0eb;border-radius:10px;padding:20px 24px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          ...
          <tr>
            <td style="padding:4px 0;">
              <span style="font-size:13px;color:#4a3728;">— &nbsp;Set up your reading preferences</span>
            </td>
          </tr>
          <tr>
            <td style="padding:4px 0;">
              <span style="font-size:13px;color:#4a3728;">— &nbsp;Discover and read books from amazing authors</span>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td style="background:#fff8f0;border-left:3px solid #D8B99C;border-radius:0 8px 8px 0;padding:14px 18px;">
        <p style="margin:0;font-size:13px;color:#7a5c46;line-height:1.6;">
          If you did not create an account on SBA Reads, you can safely ignore this email.
        </p>
      </td>
    </tr>
  </table>
